    ...
    <footer className="bg-gray-50 text-gray-700">
      <div className="container mx-auto px-6 py-10">
        ...
        <div className="flex flex-wrap justify-between items-start space-y-6 md:space-y-0 ">
          ...
          <div className="w-full h-142 flex flex-wrap justify-between mb-10 border-b pb-8 text-left text-sm text-gray-500">
            <h2 className="text-2xl font-bold text-gray-800 ">Bandage</h2>
            <div className="flex space-x-4 mt-4 mr-24">
              <a href="#" className="text-[#23A6F0] hover:text-gray-600">
                <FaFacebook />
              </a>
              <a href="#" className="text-[#23A6F0] hover:text-gray-500">
                <FaTwitter />
              </a>
              <a href="#" className="text-[#23A6F0] hover:text-gray-600">
                <FaInstagram />
        ...
        {/* Bottom Section */}
        <div className="mt-10 border-t pt-4 text-left text-sm text-gray-500">
